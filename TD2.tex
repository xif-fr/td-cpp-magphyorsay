...
Note : Les factales de Newton s'inscrivent dans le domaine plus général de la \emph{dynamique holomorphique}. Pour une compréhension plus profonde des mécanismes à l'\oe uvre et de l'émergence de ce comportement fractal, on pourra visionner l'excellente vidéo de 3Blue1Brown sur le sujet : \url{https://www.youtube.com/watch?v=-RdOwhmqP5s}
